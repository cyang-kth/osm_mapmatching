...
- [2. Preprocess road network using PostGIS (can be skipped)](#2-preprocess-road-network-using-postgis)
...
bounds = (104.043162944, 104.129634503, 30.654850847362393, 30.728014046637607)
x1,x2,y1,y2 = bounds
...
The network contains reversed edges created for osm ways whose oneway is false.
